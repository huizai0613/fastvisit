...
import cn.ahyxy.fastvisit.app.ui.fragment.DiaryFragment;
...
public class DiaryActivity extends BaseActivity {
    ...
    public void initWidget() {
        ...
        instance.initDefaultBackTitle(mBaseActivity, getString(R.string.diary));

        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.add(R.id.fragment_container, new DiaryFragment());
        transaction.commit();
    }
}
