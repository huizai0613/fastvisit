package cn.ahyxy.fastvisit.weight.lib;
...
public class WrapperExpandableListAdapter extends BaseExpandableListAdapter
{
    ...
    {
        if (convertView != null) {
            final Object tag = convertView
                    .getTag(R.id.fgelv_tag_changed_visibility);
        ...
        return mWrappedAdapter.getGroupView(groupPosition, isExpanded,
                convertView, parent);
    }
    ...
    {
        return mWrappedAdapter.getChildView(groupPosition, childPosition,
