package cn.ahyxy.fastvisit.weight.flowlayout;
...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener
{
    ...
    public TagFlowLayout(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        selectSingle = ta.getBoolean(R.styleable.TagFlowLayout_select_single, false);
    ...
    public boolean performClick()
    {
        ...
        if (child != null) {
            ...
            if (mOnTagClickListener != null) {
                return mOnTagClickListener.onTagClick(child.getTagView(), pos, TagFlowLayout.this);
            }
        }
        return true;
    }
    ...
    private void doSelect(TagView child, int position)
    {
        if (mAutoSelectEffect) {
            if (!child.isChecked()) {
                ...
                if (!selectSingle || mSelectedView.size() > 1) {
